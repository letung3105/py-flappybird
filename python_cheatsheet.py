...
# A variable name can contain letters, numbers, or underscores _
# but can't start with a number

# There are 5 standard data types Numbers, Strings, List, Tuple, Dictionary
# You can store any of them in the same variable
name = 15
print(name)

# A variable can also store no data at all
name = None
print(name)
...
# Every object has attributes (color, height, weight) which are object variables. Attribute: Đặc tính
